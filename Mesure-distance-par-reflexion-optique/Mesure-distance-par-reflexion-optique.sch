...
$EndComp
$Comp
L dk_Linear-Amplifiers-Instrumentation-OP-Amps-Buffer-Amps:MCP6002-I_P U1
U 1 1 5D09F556
P 6450 3600
F 0 "U1" H 6794 3653 60  0000 L CNN
...
U 1 1 5D0A0EEF
P 1350 4000
F 0 "SW1" V 1304 4148 50  0000 L CNN
...
U 1 1 5D0A17D9
P 4350 3700
F 0 "D2" V 4389 3583 50  0000 R CNN
F 1 "OED-EL-1L2" V 4298 3583 50  0000 R CNN
...
U 1 1 5D0A248B
P 5450 3750
F 0 "D3" H 5400 4045 50  0000 C CNN
F 1 "PD204-6B" H 5400 3954 50  0000 C CNN
...
U 1 1 5D0A3232
P 4250 4550
F 0 "Q1" H 4438 4603 60  0000 L CNN
...
F 1 "1.3k" V 3684 4550 50  0000 C CNN
...
F 1 "33" H 4420 4055 50  0000 L CNN
...
U 1 1 5D0AA4DD
P 7850 3600
F 0 "R6" H 7920 3646 50  0000 L CNN
...
U 1 1 5D0AA8A7
P 1500 5550
F 0 "D1" H 1493 5766 50  0000 C CNN
...
U 1 1 5D0B2D10
P 1350 3450
F 0 "R1" H 1420 3496 50  0000 L CNN
...
U 1 1 5D0B4530
P 1350 4300
F 0 "#PWR0106" H 1350 4050 50  0001 C CNN
...
U 1 1 5D0AAEF2
P 1500 5200
F 0 "R2" H 1570 5246 50  0000 L CNN
...
U 1 1 5D1CF13E
P 6050 3950
F 0 "#PWR0108" H 6050 3700 50  0001 C CNN
...
U 1 1 5D1CFCB6
P 6450 3950
F 0 "#PWR0109" H 6450 3700 50  0001 C CNN
...
U 1 1 5D1D80E9
P 5450 3950
F 0 "#PWR0111" H 5450 3700 50  0001 C CNN
...
U 1 1 5D1D0F71
P 6450 3350
F 0 "#PWR0112" H 6450 3200 50  0001 C CNN
...
U 1 1 5D1E224F
P 8200 1650
F 0 "C1" H 8315 1696 50  0000 L CNN
...
U 1 1 5D0A6EC6
P 6700 2950
F 0 "R5" H 6770 2996 50  0000 L CNN
F 1 "1M" H 6770 2905 50  0000 L CNN
...
U 1 1 5D1E7580
P 8200 1850
F 0 "#PWR0114" H 8200 1600 50  0001 C CNN
...
Wire Wire Line
	8200 1500 8200 1450
Text Label 1450 1650 0    50   ~ 6
DEL_DETECTION
Text Label 1450 1750 0    50   ~ 6
DEL_STATUT
Text Label 1450 1850 0    50   ~ 6
PHOTODIODE
Text Label 1450 1950 0    50   ~ 6
BOUTON
Text Label 3550 4550 2    50   ~ 6
DEL_DETECTION
Text Label 1350 4950 2    50   ~ 6
DEL_STATUT
Wire Wire Line
	1500 4950 1500 5050
Text Label 8500 3600 0    50   ~ 6
PHOTODIODE
Text Label 1500 3700 0    50   ~ 6
BOUTON
Wire Wire Line
	1500 3700 1350 3700
